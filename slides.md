...
- 算法通过三个主要算子迭代地改进种群：
    ...
    2. 交叉：产生一个或两个后代，遗传物质。常见的方法是单点交叉
...
-	计算为了使用加权和法选择某个给定解，每个目标本应具有的有效“权重”
...
- 提高NSGA-II在超多目标优化问题（有4个或更多目标）
- 用基于参考线的小生境机制取代了拥挤度
1. 算法将每个种群成员与一个参考线相关联
2. 选择首先基于非支配等级，然后基于相关参考线的小生境数量
